  ...
  <q-page padding>
    <div>
      <div class="sobrenos">
          ...
          <div class="texto">
            <p class="text-center">Nossa missão é trazer para você os melhores cursos profissionalizantes. Através de uma rede de instituições de ensino, sua Capacitação estará garantida para o mercado de trabalho.</p>
          <!-- -->
